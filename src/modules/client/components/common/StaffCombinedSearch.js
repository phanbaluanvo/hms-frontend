...
const StaffCombinedSearch = ({ onSearch }) => {
    const inputRef1 = useRef(); // Doctor Search
    const inputRef2 = useRef(); // Patient Search
    const inputRef3 = useRef(); // Exam Item Search
    ...
    const handleSearch = (event) => {
        ...
        const doctorSearch = inputRef1.current.value;
        const patientSearch = inputRef2.current.value;
        const examItemSearch = inputRef3.current.value;
        onSearch({ doctorSearch, patientSearch, examItemSearch, startDate, endDate, abnormalFilter });
    };
    ...
    return (
        <form className="flex items-center space-x-4 mb-4" onSubmit={handleSearch}>
            ...
            <div className="relative w-3/12">
                <input
                    type="text"
                    name="search-bar-doctor"
                    id="search-bar-doctor"
                    ref={inputRef1}
            ...
            <div className="relative w-3/12">
                <input
                    type="text"
                    name="search-bar-patient"
                    id="search-bar-patient"
                    ref={inputRef2}
...
export default StaffCombinedSearch;
